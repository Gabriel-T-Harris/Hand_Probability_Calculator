...
public enum Lexeme_Types
{
    ...
    CONDITION_SCENARIO_END, CONDITION_EXPR_START, CONDITION_EXPR_END, OR, AND, XOR, DISPLAY_START, TRUE, FALSE, LINE_COMMENT, BLOCK_COMMENT, INTEGER, DRAW, MILL, BANISH, REASONING,
    COMBINATORIC, SPECIAL_ABILITY_START, USES, CONDITION_FIELD, CONDITION_GY, CONDITION_BANISH, _SPECIAL_SEPARATOR, UNKNOWN_CHARACTER_ERROR, ID_ERROR, BLOCK_COMMENT_ERROR;

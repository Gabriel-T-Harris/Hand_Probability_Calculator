...
public class Token
{
    ...
    {
        DECK_START, CARD_NAME, SEMI_COLON, PROBABILITY_START, SENTINEL_START, SENTINEL_END, SCENARIO_NAME, ASSIGN, TREE_START, NOT, CONDITION_CARD_START, CONDITION_CARD_END,
